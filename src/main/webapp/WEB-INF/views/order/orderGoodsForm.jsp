...
<script>
  ...
  window.onload=function()//셀렉트박스에 주문자 휴대폰번호 표시
  {
    init();
  }
...
function fn_process_pay_order(){
	...
	alert("최종 결제하기");//버튼 클릭시 <input>태그 동적생성, 컨트롤러 전송
...
<form  name="form_order">	
	...
	<br>
	<table width=80% class="list_view" style="background: #F6EC90">
		<tbody>
